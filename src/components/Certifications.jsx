...
//     <section
//       id="certifications"
//       className="py-16 px-4 bg-gradient-to-br from-[#0d011d] via-[#1a0133] to-[#100023] text-white"
//     >
...
//         {/* Responsive grid: 1 col on small, 3 cols on md+ */}
//         <div className="grid gap-8 w-full sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">

//           {certifications.map((cert, i) => (
//             <div
//               key={i}
//               className="relative group bg-[#1b0b2e] border border-purple-700 rounded-xl overflow-hidden shadow-md"
//             >
//               {/* Rotating Image */}
//               <img
...
//               {/* Hover Overlay */}
//               <div className="absolute inset-0 bg-black bg-opacity-70 opacity-0 group-hover:opacity-100 transition duration-300 flex flex-col justify-center items-center px-4 text-center">
//                 <h3 className="text-lg font-semibold mb-2">{cert.category}</h3>
//                 <a
//                   href={cert.github}
//                   target="_blank"
