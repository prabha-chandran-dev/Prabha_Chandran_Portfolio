...
<p className="text-center text-gray-200 mb-8">
  ...
  className="relative group rounded-xl border border-purple-700 shadow-md bg-[#1b0b2e] overflow-hidden flex flex-col"
>
  ...
  {/* Bottom Title */}
  <div className="bg-[#290f4a] text-center py-2 z-10">
    <h3 className="text-md font-medium text-white">{project.title}</h3>
  </div>

  {/* Hover Overlay */}
  <div className="absolute inset-0 bg-black bg-opacity-90 opacity-0 group-hover:opacity-100 transition duration-300 flex flex-col justify-center items-center px-4 text-center z-20 overflow-y-auto">
